...
import { CHAT_CONTROLLER_DIALOGS } from './controller/dialogs';
...
import { CHAT_CONTROLLER_COMMAND_ACTIONS } from './controller/commandActions';
...
export const CHAT_VIEW_CONTROLLER = [
  ...
  CHAT_CONTROLLER_COMMAND_ACTIONS,
