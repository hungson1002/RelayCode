...
<body data-language="${language}">
  ...
  <section id="setup" class="setup hidden">
    ...
    <div class="launch-panel">
      ...
      <div class="connection-page-actions"><button id="startRouter" class="primary">Khởi động 9Router</button><button id="openDashboard" class="primary hidden">Mở trang quản lý</button><button id="retryConnection" class="secondary">Kiểm tra kết nối</button></div>
