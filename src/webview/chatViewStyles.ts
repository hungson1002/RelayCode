...
const errorAndMotionPolishStyles = String.raw`
  ...
  .chat-error-card{display:grid;grid-template-columns:28px minmax(0,1fr);gap:10px;padding:13px 14px;border:1px solid rgba(244,126,126,.35);border-radius:15px;background:rgba(72,31,32,.48)}
  .chat-error-icon{display:grid;place-items:center;width:22px;height:22px;border:1.5px solid #f09a9a;border-radius:50%;color:#ffaaaa;font-weight:750;font-size:13px}
